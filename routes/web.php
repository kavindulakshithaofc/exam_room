...
Route::group(['middleware'=> 'coming_soon'], function(){
  ...
  Route::post('admin/delete-account-request', [DeleteAccountController::class ,'store'])->name('delete.user.account');
  ...
  Route::get('admin/pwa-setting', [PWASettingController::class, 'show'])->name('pwa.show');
